...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, swarm_trajs_sub_, broadcast_bspline_sub_, trigger_sub_,myWaypoint_sub;
   ...
   //自定义订阅回调
    void myWaypointCallback(const geometry_msgs::PoseStampedPtr &msg);
